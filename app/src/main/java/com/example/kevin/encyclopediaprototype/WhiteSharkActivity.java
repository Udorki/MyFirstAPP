...
public class WhiteSharkActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_white_shark);
    ...
    private void dataWhiteShark(){
        //String url = "http://192.168.201.15:40000/api/animal/2";
        String url = "http://192.168.1.40:40000/api/animal/2";
